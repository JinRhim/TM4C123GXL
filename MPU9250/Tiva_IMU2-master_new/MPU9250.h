...
#define MPU9250_GYRO_FULL_SCALE_250DPS  0
#define MPU9250_GYRO_FULL_SCALE_500DPS  8
#define MPU9250_GYRO_FULL_SCALE_1000DPS 16
#define MPU9250_GYRO_FULL_SCALE_2000DPS 24
...
//extern void I2C1ReadBit(uint8_t devAddr, uint8_t regAddr, uint8_t bitNum, uint8_t *value);
//extern void I2C1ReadBits(uint8_t devAddr, uint8_t regAddr, uint8_t bitStart, uint8_t length, uint8_t *value);
//extern void I2C1ReadByte(uint8_t devAddr, uint8_t regAddr, uint8_t *value);
//extern void I2C1ReadBytes(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *value);
//extern void I2C1WriteBit(uint8_t devAddr, uint8_t regAddr, uint8_t bitNum, uint8_t value);
//extern void I2C1WriteBits(uint8_t devAddr, uint8_t regAddr, uint8_t bitStart, uint8_t length, uint8_t value);
//extern void I2C1WriteByte(uint8_t devAddr, uint8_t regAddr, uint8_t value);
//extern void I2C1WriteBytes(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *value);
//extern void I2C1WriteWord(uint8_t devAddr, uint8_t regAddr, uint16_t value);
//extern void I2C1WriteWords(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint16_t *value);  

////////void MPU9250_GetGyro(int16_t* gx, int16_t* gy, int16_t* gz);
////////void MPU9250_GetAcc(int16_t* ax, int16_t* ay, int16_t* az);
////////void MPU9250_GetComp(int16_t* mx, int16_t* my, int16_t* mz);

//void MPU9250_GetGyro(uint16_t* gx, uint16_t* gy, uint16_t* gz);
//void MPU9250_GetAcc(uint16_t* ax, uint16_t* ay, uint16_t* az);
//void MPU9250_GetComp(uint16_t* mx, uint16_t* my, uint16_t* mz);
...
void MPU9250_setFullScaleMagRange(void);
void MPU9250_setSleepDisabled(void); 
uint8_t MPU9250_getFullScaleAccelRange(void);
void MPU9250_ConfigureAcceleromterLowPassFilter(void);
void MPU9250_setMagPowerDown(void);
void MPU9250_setMagFuseROM(void);
void MPU9250_setMagContinousMeasurementMode(void);
void MPU9250_setAccelSelfTest(void);
void MPU9250_setGyroSelfTest(void);
void MPU9250_clearGyroSelfTest(void);
void MPU9250_clearAccelSelfTest(void);
